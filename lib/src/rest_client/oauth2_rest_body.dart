...
class OAuth2FileBody implements OAuth2RestBody
{
  ...
  OAuth2FileBody(this.fileStream, {String? contentType, required int contentLength}) : _contentType = contentType, _contentLength = contentLength;

  @override
  List<int> toBytes() 
  {
    throw UnimplementedError('OAuth2FileBody는 toBytes()를 지원하지 않습니다. toStream()을 사용하세요.');
  }
